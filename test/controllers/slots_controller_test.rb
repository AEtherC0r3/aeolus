...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { climate_control_unit_id: @slot.climate_control_unit_id, identifier: @slot.identifier, node_id: @slot.node_id } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { climate_control_unit_id: @slot.climate_control_unit_id, identifier: @slot.identifier, node_id: @slot.node_id } }
